...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA "app" to :"lark_bot_user";
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA "app" to :"lark_bot_user";
ALTER DEFAULT PRIVILEGES IN SCHEMA "app" GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES to :"lark_bot_user";
